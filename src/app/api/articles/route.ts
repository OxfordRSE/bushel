...
/**
 * Proxy endpoint for Figshare's /v2/articles (public articles)
 * 
 * This endpoint returns public articles and can be filtered by institution/group.
...
export async function GET(request: NextRequest) {
  ...
  const figshareUrl = new URL('https://api.figshare.com/v2/articles');
  
  // Forward all query parameters (page, page_size, group, institution, etc.)
