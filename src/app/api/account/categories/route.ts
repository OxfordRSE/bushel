...
/**
 * Proxy endpoint for Figshare's /v2/account/categories
 * 
...
export async function GET(request: NextRequest) {
  ...
  const figshareUrl = new URL('https://api.figshare.com/v2/account/categories');
  
  // Forward all query parameters (if any)
