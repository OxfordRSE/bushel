...
/**
 * Proxy endpoint for Figshare's /v2/item_types
 * 
 * This endpoint returns available item types (e.g., dataset, figure, etc.).
...
export async function GET(request: NextRequest) {
  ...
  const figshareUrl = new URL('https://api.figshare.com/v2/item_types');
